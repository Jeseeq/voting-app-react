import {FETCH_POLLS, FETCH_POLLS_FAILURE, FETCH_POLLS_SUCCESS, RESET_POLLS,
  FETCH_POLL, FETCH_POLL_SUCCESS, FETCH_POLL_FAILURE, RESET_POLL,
} from '../actions/polls';
...
export default function(state = INITIAL_STATE, action) {
  ...
  case FETCH_POLL:
    return {...state, activePoll: {...state.activePost, loading: true}};
  case FETCH_POLL_SUCCESS:
    return {...state, activePoll: {poll: action.payload.data, error: null, loading: false}};
